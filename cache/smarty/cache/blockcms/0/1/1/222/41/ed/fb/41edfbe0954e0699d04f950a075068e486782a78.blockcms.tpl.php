...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5679ceef3ef8b0_43705492',
  'has_nocache_code' => true,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5679ceef3ef8b0_43705492')) {function content_5679ceef3ef8b0_43705492($_smarty_tpl) {?>
	<!-- Block CMS module -->
			<section id="informations_block_left_1" class="block informations_block_left">
			<p class="title_block">
				<a href="http://fitis.vn/content/category/1-home">
					Information				</a>
			</p>
			<div class="block_content list-block">
				<ul>
																							<li>
								<a href="http://fitis.vn/content/1-delivery" title="Delivery">
									Delivery
								</a>
							</li>
																								<li>
								<a href="http://fitis.vn/content/2-legal-notice" title="Legal Notice">
									Legal Notice
								</a>
							</li>
																								<li>
								...
								<a href="http://fitis.vn/content/4-about-us" title="About us">
									About us
																								...
																								<li>
								<a href="http://fitis.vn/content/5-secure-payment" title="Secure payment">
									Secure payment
								</a>
							</li>
																						<li>
